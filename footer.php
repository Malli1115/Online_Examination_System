    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 column-td-half">
                <div class="footer-widget">
                     <h3 class="widget-title">Our Institute</h3>
                    <span class="section-divider"></span>
                   <ul class="list-items">
                        <li><a href="#">3rd Floor, SRM Compex, </a></li>
                        <li><a href="#">Kailash Nagar,</a></li>
                        <li><a href="#">Tiruchirappalli, Tamil Nadu-620019</a></li>
                        <li><a href="#">97903 21115</a></li>
                    </ul>
        ...
        <div class="copyright-content">
            <div class="row align-items-center">
                <div class="col-lg-10">
                    <p class="copy__desc">&copy; 2021 Our Institute. All Rights Reserved. by <a href="#">Milky.</a></p>
                </div><!-- end col-lg-9 -->
