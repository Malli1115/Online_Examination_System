                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-white">
									...
									<div class="form-group">
                                     ...
                                     <div class="form-group">
                                            <label for="exampleInputEmail1">Total Reviews</label>
                                            <input type="text" class="form-control" placeholder="No of Reviews" name="review" required autocomplete="off">
                                        </div>
                                         <div class="form-group">
                                            <label for="exampleInputEmail1">Rating</label>
                                            <input type="text" class="form-control" placeholder="Rating" name="rating" required autocomplete="off">
                                        </div>
