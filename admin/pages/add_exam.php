...
$review = ucfirst(mysqli_real_escape_string($conn, $_POST['review']));
$rating = ucfirst(mysqli_real_escape_string($conn, $_POST['rating']));
...
$sql = "INSERT INTO tbl_examinations (exam_id, category, subject, exam_name, date, duration, passmark, re_exam, terms,review,rating)
VALUES ('$exam_id', '$category', '$subject', '$exam', '$date', '$duration', '$passmark', '$attempts', '$terms', '$review', '$rating')";
