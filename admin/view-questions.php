                                        ...
                                        <div class="tabs-below" role="tabpanel">
                                            ...
                                            while($row = $result->fetch_assoc()) {
                                                ...
                                                $r_answer = $row['answer'];
                                                  ...
                                                  if($imge){
                                                    $simge = $imge; $high  = '95px';
                                                  }else{
                                                    $simge = 'whitebg.jpg'; $high  = '1px';
                                                  }
											...
											<div role="tabpanel" class="tab-pane active fade in" id="tab'.$qno.'">
                                             <p><b>'.$qno.'.</b> '.$qs.'</p>
                                             <img src="../assets/uploads/'.$simge.'" style="height:'.$high.'">
											...
											<div role="tabpanel" class="tab-pane active fade in" id="tab'.$qno.'">
                                             <p><b>'.$qno.'.</b> '.$qs.'</p>
                                            <img src="../assets/uploads/'.$simge.'" style="height:'.$high.'">
											 <p><input type="radio" name="'.$qno.'"  class="form-control" value='.$op1.'> '.$op1.'
                                             <span>'.(($opi1!='')?'<img src="../assets/uploads/answer/'.$opi1.'" style="height:100px">':"").'</span></p>
                                             
											 <p><input type="radio" name="'.$qno.'"  class="form-control" value='.$op2.'> '.$op2.'
                                             <span>'.(($opi2!='')?'<img src="../assets/uploads/answer/'.$opi2.'" style="height:100px">':"").'</span></p>
                                             
											 <p><input type="radio" name="'.$qno.'"  class="form-control" value='.$op3.'> '.$op3.'
                                             <span>'.(($opi3!='')?'<img src="../assets/uploads/answer/'.$opi3.'" style="height:100px">':"").'</span></p>
                                             
											 <p><input type="radio" name="'.$qno.'"  class="form-control" value='.$op4.'> '.$op4.'
                                             <span>'.(($opi4!='')?'<img src="../assets/uploads/answer/'.$opi4.'" style="height:100px">':"").'</span></p>
                                             
											 <hr>
                                      
                                           <p>Right Answe Is : <span style="color:green">'.$r_answer.'</span></p>
											...
											<div role="tabpanel" class="tab-pane fade in" id="tab'.$qno.'">
											 ...
											 <p><input type="radio" name="'.$qno.'"  class="form-control" value='.$op1.'> '.$op1.'
                                             <span>
                                             '.(($opi1!='')?'<img src="../assets/uploads/answer/'.$opi1.'" style="height:100px">':"").'</span></p>
											 <p><input type="radio" name="'.$qno.'"  class="form-control" value='.$op2.'> '.$op2.'
                                             <span>'.(($opi2!='')?'<img src="../assets/uploads/answer/'.$opi2.'" style="height:100px">':"").'</span></p>
