								 ...
								 if ($type == "MC") {
									 print '
									  <form action="pages/update_question.php?type=mc" method="POST">
                                                ...
                                                <img src="../assets/uploads/'.$imge.'" style="height:130px">
                                                </div>
                                      ...
                                      <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <input type="text" value="'.$opt1.'" class="form-control" placeholder="Enter option 1" name="opt1" required autocomplete="off"><br>
                                                '.(($opi1!='')?'<img src="../assets/uploads/answer/'.$opi1.'" style="height:100px">':"").'
                                                </div>
												</td>
                                            ...
                                            <tr>
                                                ...
                                                <input type="text" class="form-control" value="'.$opt2.'" placeholder="Enter option 2" name="opt2" required autocomplete="off"><br>
                                                '.(($opi1!='')?'<img src="../assets/uploads/answer/'.$opi2.'" style="height:100px">':"").'
                                                </div>
												</td>
                                            ...
                                            <tr>
                                                ...
                                                <input type="text" class="form-control" value="'.$opt3.'" placeholder="Enter option 3" name="opt3" required autocomplete="off"><br>
                                                '.(($opi1!='')?'<img src="../assets/uploads/answer/'.$opi3.'" style="height:100px">':"").'
                                                </div>
												</td>
											...
											<tr>
                                                ...
                                                <input type="text" class="form-control" value="'.$opt4.'" placeholder="Enter option 4" name="opt4" required autocomplete="off"><br>
                                                '.(($opi1!='')?'<img src="../assets/uploads/answer/'.$opi4.'" style="height:100px">':"").'
                                                </div>
												</td>
