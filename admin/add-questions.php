                                        ...
                                        <div role="tabpanel">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter question" name="question" required autocomplete="off">
                                                  ...
                                                  <br><input type="file" name="photo" accept="image/*" autocomplete="off">
                                      ...
                                      <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <br><input type="file" name="fstimg" accept="image/*" autocomplete="off">
                                                </div>
												</td>
                                            ...
                                            <tr>
                                                ...
                                                <br><input type="file" name="sedimg" accept="image/*" autocomplete="off">
                                                </div>
												</td>
                                            ...
                                            <tr>
                                                ...
                                                <br><input type="file" name="trdimg" accept="image/*" autocomplete="off">
                                                </div>
												</td>
											...
											<tr>
                                                ...
                                                <br><input type="file" name="frtimg" accept="image/*" autocomplete="off">
                                                </div>
												</td>
