...
$sql = "UPDATE tbl_assessment_records SET score='$percent_score',total_questions='$questions',total_mark='$result_marks', status='$status' WHERE record_id='$record'";
