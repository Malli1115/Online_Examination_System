                                    ...
                                    <div class="panel-body">
                                       ...
                                       <form action="pages/submit_assessment.php" method="POST" name="quiz" id="quiz_form" >
											...
											<div role="tabpanel" class="tab-pane active fade in" id="tab'.$qno.'">
                                             <p><b>'.$qno.'.</b> '.$qs.'</p>
                                             '.(($imge!='')?'<img src="../assets/uploads/'.$imge.'" style="height:130px">':"").'
											 <p><input type="radio" name="an'.$qno.'"  class="form-control" value="'.$op1.'"> '.$op1.'
                                             <span>'.(($opi1!='')?'<img src="../assets/uploads/answer/'.$opi1.'" style="height:100px">':"").'</span></p>
											 <p><input type="radio" name="an'.$qno.'"  class="form-control" value="'.$op2.'"> '.$op2.'
                                             <span>'.(($opi2!='')?'<img src="../assets/uploads/answer/'.$opi2.'" style="height:100px">':"").'</span></p>
											 <p><input type="radio" name="an'.$qno.'"  class="form-control" value="'.$op3.'"> '.$op3.'
                                             <span>'.(($opi3!='')?'<img src="../assets/uploads/answer/'.$opi3.'" style="height:100px">':"").'</span></p>
											 <p><input type="radio" name="an'.$qno.'"  class="form-control" value="'.$op4.'"> '.$op4.'
