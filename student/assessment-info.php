...
if ($result->num_rows > 0) {
    ...
    echo "<script>
alert('Please Wirte a Exam First');
            ...
            <div class="page-inner">
                ...
                <div id="main-wrapper">
                    <div class="row col-md-12">
                      ...
                      <center><a href="view_answer.php?eid=<?php echo "$exam_id";?>"><button class="btn btn-success">View Right Answers</button></a></center>
                           ...
                           <div class="col-md-6">
                            <div class="panel panel-white">
                              ...
                              <br> <h3 class="widget-title">Give Reviews For That Exam</h3>
                            ...
                            <i class="la la-pencil input-icon"></i>
                                                    ...
                                                    <button class="btn btn-success" type="submit" name="result">submit</button>
                                    </form>
