            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        <li ><a href="./" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-th-large"></span><p>Dashboard</p></a></li>
                      ...
                      <div class="row">
						...
						<div class="row">
							...
							<!-- <div class="col-md-7">
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
									<h3>Update password / Category</h3>
			                    <form action="pages/new_pw.php" method="POST">

                                    <div class="form-group">
                                <label for="exampleInputEmail1">Change Category</label>
                                ...
                                <h3>Once Change a Category Again Logout And Login Your Account !</h3>
