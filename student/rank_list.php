                ...
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li><a href="results.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-certificate"></span><p>Exam Results</p></a></li>
                         ...
                         <li class="active"><a href="rank_list.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-user"></span><p>Overall Rank List</p></a></li>
                                        ...
                                        <tbody>';
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <td><a href="view-rank_list.php?eid='.$row['exam_id'].'">View Results</a></td>
