                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-4 center">
                            <div class="login-box">
                                <a href="./" class="logo-name text-lg text-center">Login First And Take Test !</a>
                                <p class="text-center m-t-md">Don't Have Account First Register Now</p>
                                <form class="m-t-md" action="pages/authentication.php" method="POST">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Your Email Id"  autocomplete="off" name="user" required>
                                    </div>
                                    <div class="form-group">
                                ...
                                <center><span><a href="sign-up.php"><button class="btn btn-info">Register Now</button></a></span>
                                    <span><a href="index.php"><button class="btn btn-primary">Back To Home</button></a></span></center>
